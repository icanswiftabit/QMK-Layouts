...
[_NUMBERS] = LAYOUT( \
 ...
 KC_LSFT, LCTL_T(KC_LBRC), RALT_T(KC_RBRC), LGUI_T(KC_SCLN), XXXXXXX,      XXXXXXX, RGUI_T(KC_4), RALT_T(KC_5), RCTL_T(KC_6), KC_RSFT, \
 XXXXXXX,         KC_BSLS,         KC_SLSH,         KC_QUOT, XXXXXXX,      XXXXXXX, KC_1,         KC_2,      KC_3,       XXXXXXX, \
...
[_ARROWS] = LAYOUT( \
                 ...
                 KC_LSFT,    KC_RCTRL,  KC_RALT,    KC_LGUI, XXXXXXX,     XXXXXXX, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, \
                 XXXXXXX, KC__VOLDOWN, KC__MUTE,  KC__VOLUP, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
