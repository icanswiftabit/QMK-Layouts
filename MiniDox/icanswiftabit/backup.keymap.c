...
[_QWERTY] = LAYOUT( \
        ...
        LSFT_T(KC_A), LCTL_T(KC_S), RALT_T(KC_D), LGUI_T(KC_F), KC_G,     KC_H, RGUI_T(KC_J),  RALT_T(KC_K), RCTL_T(KC_L), KC_RSFT, \
                KC_Z,         KC_X,         KC_C,         KC_V, KC_B,     KC_N, KC_M,          KC_COMM,      KC_DOT,       XXXXXXX, \
                     OSL(_PROGRAMS), KC_BSPACE, LT(_ARROWS, KC_ENT),    LT(_NUMBERS2, KC_TAB), KC_SPACE,     XXXXXXX    \
),
 ...
 *                    |         |    `    |    -    |    =    |     |     |     |    7    |    8    |    9    |   0   |
 *                    |---------+---------+---------+---------+-----|     |-----+---------+---------+---------+-------|
 *                    | KC_LSFT |LCTL_T([)|RALT_T(])|LGUI_T(\)|LCTL(AR LEFT)|     |     |RGUI_T(4)|RALT_T(5)|RCTL_T(6)|KC_RSFT|
 *                    |---------+---------+---------+---------+-----|     |-----+---------+---------+---------+-------|
 *                    |         |    ;    |    '    |    /    |LCTL(AR RGHT)|     |     |    1    |    2    |    3    |       |
 *                    `---------------------------------------------'     `-------------------------------------------'
 *                                          ,-----------------------.     ,-----,-------------.
...
[_NUMBERS1] = LAYOUT( \
 ...
 KC_LSFT, LCTL_T(KC_LBRC), RALT_T(KC_RBRC), LGUI_T(KC_BSLS), LCTL(KC_LEFT),      XXXXXXX, RGUI_T(KC_4), RALT_T(KC_5), RCTL_T(KC_6), KC_RSFT, \
 XXXXXXX,         KC_SCLN,         KC_QUOT,         KC_SLSH, LCTL(KC_RGHT),      XXXXXXX, KC_1,         KC_2,      KC_3,       XXXXXXX, \
                                           XXXXXXX,  KC_ESC, XXXXXXX,      XXXXXXX, KC_0, XXXXXXX                 \
),
