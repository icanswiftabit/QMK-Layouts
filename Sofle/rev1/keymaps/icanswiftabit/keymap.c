...
[3] = LAYOUT(
  ...
  KC_J,  KC_TAB,   KC_Q, KC_W,  KC_E, KC_R,                        _______, _______,   _______, _______,_______, _______,
  _______, KC_LEFT_SHIFT, KC_A, KC_S,  KC_D, KC_F,                       _______,  _______, _______, _______,  _______, _______,
  KC_K,    KC_Z, KC_X, KC_C, KC_V, KC_B,                           _______, _______, _______, _______,   _______, _______,
  _______,KC_LEFT_GUI, KC_LEFT_ALT, KC_M, KC_L, KC_SPACE,       _______, _______, _______, _______, _______,
                                                              KC_ENTER, KC_RIGHT, KC_UP, KC_LEFT, KC_DOWN
)
};

const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [0] = { ENCODER_CCW_CW(MS_WHLU, MS_WHLD), ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [1] = { ENCODER_CCW_CW(KC_BRIGHTNESS_UP, KC_BRIGHTNESS_DOWN), ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [2] = { ENCODER_CCW_CW(KC_AUDIO_VOL_UP, KC_AUDIO_VOL_DOWN), ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
