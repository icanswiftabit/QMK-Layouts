...
const uint16_t PROGMEM spotlight_combo[] = {KC_RALT, RGUI(RSFT(KC_P)), COMBO_END};
...
bool combo_should_trigger(uint16_t combo_index, combo_t *combo, uint16_t keycode, keyrecord_t *record) {
    if (get_highest_layer(layer_state|default_layer_state) == WIN_GAME) {
        return false;
    }
    return true;
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_82(
        ...
        KC_LCTL,             KC_LOPT,  KC_LGUI,                                    KC_SPC,                       KC_LGUI,  KC_RALT,  RGUI(RSFT(KC_P)),   KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_FN] = LAYOUT_ansi_82(
        ...
        _______,                                S(A(G(KC_F))),          LGUI(KC_DOWN),                LGUI(KC_UP),          _______,              _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,
        _______,  _______,                      _______,                                                                    KC_ENT,                                   _______,  _______,  _______,  _______,  _______,  _______),

    [WIN_BASE] = LAYOUT_ansi_82(
        LGUI(KC_L),          KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL,            HYPR(KC_F19),
        LT(WIN_FN, KC_GRV),  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     XXXXXXX,  XXXXXXX,  XXXXXXX,           KC_PGUP,
        ...
        SC_LSPO,                       KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_K,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            SC_RSPC,           KC_UP,
        KC_LGUI,             KC_RALT,  KC_LCTL,                                KC_SPC,                       KC_RCMD,  KC_RALT,  TG(WIN_GAME),       KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_GAME] = LAYOUT_ansi_82(
        TG(WIN_GAME),  KC_F1,    KC_F2,       KC_F3,     KC_F4,     KC_F5,     KC_F6,     KC_F7,           KC_F8,     KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL,   KC_MUTE,
        KC_GRV,        KC_1,     KC_2,        KC_3,      KC_4,      KC_5,      KC_6,      KC_7,            KC_8,      KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,  KC_PGUP,
        KC_TAB,        KC_Q,     KC_W,        XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_ESC,          KC_TAB,    KC_Q,     KC_W,     KC_E,     KC_R,     KC_P,     KC_PGDN,
        KC_ESC,        KC_A,     KC_R,        XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,         KC_LSFT,   KC_A,     KC_S,     KC_D,               KC_F,     KC_HOME,
        KC_LSFT,                 KC_Z,        XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_K,            KC_Z,      KC_X,     KC_C,     KC_V,               KC_B,     KC_UP,
        KC_O,          KC_RALT,  KC_LCTL,                                       KC_SPC,                               XXXXXXX,  KC_M,     KC_L,     KC_SPC,   KC_DOWN,  KC_RGHT),
};
